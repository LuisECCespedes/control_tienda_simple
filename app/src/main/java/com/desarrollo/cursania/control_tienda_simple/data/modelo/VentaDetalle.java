...
public class VentaDetalle {
    ...
    {
        return Metodos.CadenasComponer(caracter,new Object[]{vd_id, vd_cantidad, vd_precio, vc_id, prod_nombre, prod_ruta_foto});
    }

    public VentaDetalle ventaDetalle(String cadena, String caracter)
    {
        return new VentaDetalle(  Integer.parseInt(Metodos.CadenasDescomponer(cadena,1,caracter)),
                Integer.parseInt(Metodos.CadenasDescomponer(cadena,2,caracter)),
                Double.parseDouble(Metodos.CadenasDescomponer(cadena,3,caracter)),
                Integer.parseInt(Metodos.CadenasDescomponer(cadena,4,caracter)),
